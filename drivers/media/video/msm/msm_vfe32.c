...
/*10*/  {V32_ROLL_OFF_CFG, V32_ROLL_OFF_CFG_LEN, V32_ROLL_OFF_CFG_OFF,
		...
		{V32_DEMOSAIC_0_CFG, V32_DEMOSAIC_0_LEN, V32_DEMOSAIC_0_OFF,
		0xFF},
		{V32_DEMOSAIC_1_CFG, V32_DEMOSAIC_1_LEN, V32_DEMOSAIC_1_OFF,
		0xFF},
		{V32_DEMOSAIC_2_CFG, V32_DEMOSAIC_2_LEN, V32_DEMOSAIC_2_OFF,
		0xFF},
/*15*/	{V32_FOV_CFG, V32_FOV_LEN, V32_FOV_OFF, 0xFF},
		{V32_MAIN_SCALER_CFG, V32_MAIN_SCALER_LEN, V32_MAIN_SCALER_OFF,
		0xFF},
		{V32_WB_CFG, V32_WB_LEN, V32_WB_OFF, 0xFF},
		{V32_COLOR_COR_CFG, V32_COLOR_COR_LEN, V32_COLOR_COR_OFF, 0xFF},
		{V32_RGB_G_CFG, V32_RGB_G_LEN, V32_RGB_G_OFF, 0xFF},
/*20*/	{V32_LA_CFG, V32_LA_LEN, V32_LA_OFF, 0xFF },
		{V32_CHROMA_EN_CFG, V32_CHROMA_EN_LEN, V32_CHROMA_EN_OFF, 0xFF},
		{V32_CHROMA_SUP_CFG, V32_CHROMA_SUP_LEN, V32_CHROMA_SUP_OFF,
		0xFF},
		{V32_MCE_CFG, V32_MCE_LEN, V32_MCE_OFF, 0xFF},
		{V32_SK_ENHAN_CFG, V32_SCE_LEN, V32_SCE_OFF, 0xFF},
/*25*/	{V32_ASF_CFG, V32_ASF_LEN, V32_ASF_OFF, 0xFF},
		{V32_S2Y_CFG, V32_S2Y_LEN, V32_S2Y_OFF, 0xFF},
		{V32_S2CbCr_CFG, V32_S2CbCr_LEN, V32_S2CbCr_OFF, 0xFF},
		{V32_CHROMA_SUBS_CFG, V32_CHROMA_SUBS_LEN, V32_CHROMA_SUBS_OFF,
		0xFF},
		{V32_OUT_CLAMP_CFG, V32_OUT_CLAMP_LEN, V32_OUT_CLAMP_OFF,
		0xFF},
/*30*/	{V32_FRAME_SKIP_CFG, V32_FRAME_SKIP_LEN, V32_FRAME_SKIP_OFF,
		0xFF},
		{V32_DUMMY_1},
		{V32_DUMMY_2},
		{V32_DUMMY_3},
		{V32_UPDATE},
/*35*/	{V32_BL_LVL_UPDATE, V32_BLACK_LEVEL_LEN, V32_BLACK_LEVEL_OFF,
		0xFF},
		{V32_DEMUX_UPDATE, V32_DEMUX_LEN, V32_DEMUX_OFF, 0xFF},
		{V32_DEMOSAIC_1_UPDATE, V32_DEMOSAIC_1_LEN, V32_DEMOSAIC_1_OFF,
		0xFF},
		{V32_DEMOSAIC_2_UPDATE, V32_DEMOSAIC_2_LEN, V32_DEMOSAIC_2_OFF,
		0xFF},
		{V32_FOV_UPDATE, V32_FOV_LEN, V32_FOV_OFF, 0xFF},
/*40*/	{V32_MAIN_SCALER_UPDATE, V32_MAIN_SCALER_LEN, V32_MAIN_SCALER_OFF,
		0xFF},
...
/*45*/	{V32_CHROMA_EN_UPDATE, V32_CHROMA_EN_LEN, V32_CHROMA_EN_OFF,
		0xFF},
...
/*50*/	{V32_S2Y_UPDATE, V32_S2Y_LEN, V32_S2Y_OFF, 0xFF},
...
/*55*/	{V32_STATS_AE_UPDATE, V32_STATS_AE_LEN, V32_STATS_AE_OFF},
...
/*60*/	{V32_STATS_IHIST_UPDATE, V32_STATS_IHIST_LEN, V32_STATS_IHIST_OFF},
		{V32_DUMMY_4},
		{V32_EPOCH1_ACK},
		{V32_EPOCH2_ACK},
		{V32_START_RECORDING},
/*65*/	{V32_STOP_RECORDING},
		{V32_DUMMY_5},
		{V32_DUMMY_6},
...
/*100*/	{V32_STATS_SKIN_STOP},
		...
		{V32_SYNC_TIMER_SETTING, V32_SYNC_TIMER_LEN,
			V32_SYNC_TIMER_OFF},
/*105*/	{V32_ASYNC_TIMER_SETTING, V32_ASYNC_TIMER_LEN, V32_ASYNC_TIMER_OFF},
		{V32_LIVESHOT},
		{V32_LA_SETUP},
		{V32_LINEARIZATION, V32_LINEARIZATION_LEN1,
					V32_LINEARIZATION_OFF1},
		{V32_DEMOSAICV3},
		{V32_DEMOSAICV3_ABCC_CFG},
...
static int vfe32_config_axi(int mode, struct axidata *ad, uint32_t *ao)
{
	...
	case OUTPUT_2: {
		if (ad->bufnum2 != 3)
			return -EINVAL;
		vfe32_ctrl->outpath.out0.ch0 = 0; /* luma   */
		vfe32_ctrl->outpath.out0.ch1 = 1; /* chroma */
		...
		CDBG("vfe32_config_axi: free_buf paddr = 0x%x, y_off = %d,"
			" cbcr_off = %d\n",
	...
	case OUTPUT_1_AND_2:
		...
		vfe32_ctrl->outpath.out0.ch0 = 0; /* thumbnail luma   */
		vfe32_ctrl->outpath.out0.ch1 = 4; /* thumbnail chroma */
		vfe32_ctrl->outpath.out1.ch0 = 1; /* main image luma   */
		vfe32_ctrl->outpath.out1.ch1 = 5; /* main image chroma */
	...
	case OUTPUT_1_AND_3: {
		...
		*p = 0x1a03;    /* xbar cfg1 */
#endif
		vfe32_ctrl->outpath.out0.ch0 = 0; /* preview luma   */
		vfe32_ctrl->outpath.out0.ch1 = 4; /* preview chroma */
		vfe32_ctrl->outpath.out2.ch0 = 1; /* video luma     */
		vfe32_ctrl->outpath.out2.ch1 = 5; /* video chroma   */
		vfe32_ctrl->outpath.output_mode |=
		...
		outp2->free_buf.y_off = regp2->info.y_off;
		outp2->free_buf.cbcr_off = regp2->info.cbcr_off;
		CDBG("vfe32_config_axi: preview free_buf"
			"paddr = 0x%x, y_off = %d,"
			" cbcr_off = %d\n",
			outp1->free_buf.paddr, outp1->free_buf.y_off,
			outp1->free_buf.cbcr_off);
		CDBG("vfe32_config_axi: video free_buf"
			"paddr = 0x%x,y_off = %d,"
			" cbcr_off = %d\n",
	...
	msm_io_memcpy(vfe32_ctrl->vfebase + vfe32_cmd[V32_AXI_OUT_CFG].offset,
		ao, vfe32_cmd[V32_AXI_OUT_CFG].length);
	return 0;
}
...
static int vfe32_capture(uint32_t num_frames_capture)
{
	...
	if (vfe32_ctrl->operation_mode == 1) {
		...
		if (vfe32_ctrl->outpath.output_mode & VFE32_OUTPUT_MODE_PT) {
			msm_io_w(1, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
				24 * (vfe32_ctrl->outpath.out0.ch0));
			temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF +
				20 + 24 * (vfe32_ctrl->outpath.out0.ch0));
			msm_io_w(1, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
				24 * (vfe32_ctrl->outpath.out0.ch1));
			temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF +
				 20 + 24 * (vfe32_ctrl->outpath.out0.ch1));
		}
		if (vfe32_ctrl->outpath.output_mode & VFE32_OUTPUT_MODE_S) {
			msm_io_w(1, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
				24 * (vfe32_ctrl->outpath.out1.ch0));
			temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF +
				20 + 24 * (vfe32_ctrl->outpath.out1.ch0));
			msm_io_w(1, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
				24 * (vfe32_ctrl->outpath.out1.ch1));
			temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF +
				20 + 24 * (vfe32_ctrl->outpath.out1.ch1));
		}
...
static int vfe32_start(void)
{
	...
	if (vfe32_ctrl->outpath.output_mode & VFE32_OUTPUT_MODE_PT) {
		...
		msm_io_w(1, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
			24 * (vfe32_ctrl->outpath.out0.ch1));
		temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
			24 * (vfe32_ctrl->outpath.out0.ch1));
	}
	vfe32_start_common();
	return 0;
...
static int vfe32_proc_general(struct msm_vfe32_cmd *cmd)
{
	...
	case V32_BLACK_LEVEL_CFG:
		rc = -EFAULT;
		goto proc_general_done;
	case V32_DEMOSAIC_2_UPDATE: /* 38 BPC update   */
	case V32_DEMOSAIC_2_CFG: {  /* 14 BPC config   */
		rc = -EFAULT;
		goto proc_general_done;
		}
		break;
	case V32_DEMOSAIC_1_UPDATE:/* 37 ABF update  */
	case V32_DEMOSAIC_1_CFG: { /* 13 ABF config  */
		rc = -EFAULT;
		goto proc_general_done;
		}
		break;
...
static void vfe32_process_reg_update_irq(void)
{
	...
	if (vfe32_ctrl->req_start_video_rec) {
		if (vfe32_ctrl->outpath.output_mode & VFE32_OUTPUT_MODE_V) {
			msm_io_w(1, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
				24 * (vfe32_ctrl->outpath.out2.ch0));
			temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF +
				20 + 24 * (vfe32_ctrl->outpath.out2.ch0));
			msm_io_w(1, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
				24 * (vfe32_ctrl->outpath.out2.ch1));
			temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF +
				20 + 24 * (vfe32_ctrl->outpath.out2.ch1));
			/* Mask with 0x7 to extract the pixel pattern*/
		...
		if (vfe32_ctrl->outpath.output_mode & VFE32_OUTPUT_MODE_V) {
			msm_io_w(0, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
				24 * (vfe32_ctrl->outpath.out2.ch0));
			temp = msm_io_r(vfe32_ctrl->vfebase + V32_AXI_OUT_OFF +
				20 + 24 * (vfe32_ctrl->outpath.out2.ch0));
			msm_io_w(0, vfe32_ctrl->vfebase + V32_AXI_OUT_OFF + 20 +
		...
		if (vfe32_ctrl->vfe_capture_count == 0) {
			...
			if (vfe32_ctrl->outpath.output_mode &
				...
				msm_io_w(0, vfe32_ctrl->vfebase +
					V32_AXI_OUT_OFF + 20 + 24 *
					(vfe32_ctrl->outpath.out0.ch0));
				temp = msm_io_r(vfe32_ctrl->vfebase +
					V32_AXI_OUT_OFF + 20 + 24 *
					(vfe32_ctrl->outpath.out0.ch0));
				msm_io_w(0, vfe32_ctrl->vfebase +
					V32_AXI_OUT_OFF + 20 + 24 *
...
static void vfe32_set_default_reg_values(void)
{
	...
	/* stats UB config */
	msm_io_w(0x3900007, vfe32_ctrl->vfebase + VFE_BUS_STATS_AEC_UB_CFG);
	msm_io_w(0x3980007, vfe32_ctrl->vfebase + VFE_BUS_STATS_AF_UB_CFG);
	msm_io_w(0x3A0000F, vfe32_ctrl->vfebase + VFE_BUS_STATS_AWB_UB_CFG);
	msm_io_w(0x3B00007, vfe32_ctrl->vfebase + VFE_BUS_STATS_RS_UB_CFG);
	msm_io_w(0x3B8001F, vfe32_ctrl->vfebase + VFE_BUS_STATS_CS_UB_CFG);
	msm_io_w(0x3D8001F, vfe32_ctrl->vfebase + VFE_BUS_STATS_HIST_UB_CFG);
	msm_io_w(0x3F80007, vfe32_ctrl->vfebase + VFE_BUS_STATS_SKIN_UB_CFG);
}
	...
	*/
	...
	if (out_bool) {
		...
		CDBG("output path 0, pyaddr = 0x%x, pcbcraddr = 0x%x\n",
			pyaddr, pcbcraddr);
		if (vfe32_ctrl->outpath.out0.free_buf.available) {
			/* Y channel */
			vfe32_put_ch_addr(ping_pong,
			vfe32_ctrl->outpath.out0.ch0,
			vfe32_ctrl->outpath.out0.free_buf.paddr +
			vfe32_ctrl->outpath.out0.free_buf.y_off);
			/* Chroma channel */
			vfe32_put_ch_addr(ping_pong,
			vfe32_ctrl->outpath.out0.ch1,
			vfe32_ctrl->outpath.out0.free_buf.paddr +
			vfe32_ctrl->outpath.out0.free_buf.cbcr_off);
	...
	*/
	...
	if (out_bool) {
		...
		CDBG("snapshot main, pyaddr = 0x%x, pcbcraddr = 0x%x\n",
			pyaddr, pcbcraddr);
		if (vfe32_ctrl->outpath.out1.free_buf.available) {
			/* Y channel */
			vfe32_put_ch_addr(ping_pong,
			vfe32_ctrl->outpath.out1.ch0,
			vfe32_ctrl->outpath.out1.free_buf.paddr +
			vfe32_ctrl->outpath.out1.free_buf.y_off);
			/* Chroma channel */
			vfe32_put_ch_addr(ping_pong,
			vfe32_ctrl->outpath.out1.ch1,
			vfe32_ctrl->outpath.out1.free_buf.paddr +
...
static void vfe32_process_output_path_irq_2(void)
{
	...
	*/
	...
	if (out_bool) {
		...
		if (vfe32_ctrl->outpath.out2.free_buf.available) {
			/* Y channel */
			vfe32_put_ch_addr(ping_pong,
			vfe32_ctrl->outpath.out2.ch0,
			vfe32_ctrl->outpath.out2.free_buf.paddr +
			vfe32_ctrl->outpath.out2.free_buf.y_off);
			/* Chroma channel */
			vfe32_put_ch_addr(ping_pong,
			vfe32_ctrl->outpath.out2.ch1,
			vfe32_ctrl->outpath.out2.free_buf.paddr +
			vfe32_ctrl->outpath.out2.free_buf.cbcr_off);
			vfe32_ctrl->outpath.out2.free_buf.available = 0;
		}
