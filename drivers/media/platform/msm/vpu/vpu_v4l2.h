...
#define VPU_MAX_PLANES 3
#define VPU_EVENT_Q_SIZE 8
...
enum vpu_session_input_source {
	VPU_IN_SRC_HOST = 0,
	VPU_IN_SRC_TUNNELING_VCAP_0,
	VPU_IN_SRC_TUNNELING_VCAP_1,
	VPU_IN_SRC_MAX,
};

enum vpu_session_output_destination {
	VPU_OUT_DEST_HOST = 0,
	VPU_OUT_DEST_DISPLAY_0,
	VPU_OUT_DEST_DISPLAY_1,
	VPU_OUT_DEST_MAX,
};
...
struct vpu_port_info {
	...
	union {
		enum vpu_session_input_source        source;
		enum vpu_session_output_destination  destination;
	};
	u32 pipes[2];
};
