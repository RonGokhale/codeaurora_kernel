...
struct vpu_prop_sys_version {
	...
	/* system Maple firmware revision information */
...
/* logging only applied to Maple component */
#define	LOG_COMPONENT_MAPLE	0
...
struct vpu_prop_sys_log_config {
	/* component that logging config is applied to: Maple or FRC
