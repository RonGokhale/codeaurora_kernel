...
/*
 * The following values define all the interface commands between Host and
 * Maple.
 *
...
/*
 * The following values define all the interface messages between Maple and
 * Host.
 *
 ...
 * flags:	bit 0:	need Acknowledgment from Maple FW indication
 *		bit 1-31: reserved
 */
...
/* Bits: 8 - Output Src/sink addresses present */
 ...
 */
enum vpu_log_pkt {
	MAPLE_MESSAGE_PACKET,
	MAPLE_METADATA_PACKET,
	MAPLE_PIXELDATA_PACKET,

	KPROC_MESSAGE_PACKET,
	KPROC_METADATA_PACKET,
	KPROC_PIXELDATA_PACKET,
