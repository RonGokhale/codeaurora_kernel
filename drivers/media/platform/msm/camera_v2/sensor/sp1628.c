...
static struct msm_camera_i2c_reg_conf sp1628_recommend_settings[] = {
	...
	{0x73, 0x23,},	// 28
	{0x74, 0x23,},	// 2a
	{0x75, 0x46,},	// [7:4] strength of flat area, [3:0]strength of un-flat area; 0-max, 8-min
	{0x76, 0x36,},
	{0x77, 0x36,},	// 25
	{0x78, 0x36,},	// 12
	{0x81, 0x1d,},	// 2x
	...
	void __user *argp)
{
	...
	case CFG_SET_INIT_SETTING:
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client, sp1628_recommend_settings,
...
int32_t sp1628_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	CDBG("%s, E. calling i2c_read:, i2c_addr:%d, id_reg_addr:%d", __func__, s_ctrl->sensordata->slave_info->sensor_slave_addr, s_ctrl->sensordata->slave_info->sensor_id_reg_addr);
