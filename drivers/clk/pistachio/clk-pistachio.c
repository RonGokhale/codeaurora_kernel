...
static struct pistachio_gate pistachio_gates[] __initdata = {
	...
	GATE(CLK_PERIPH_SYS_CORE, "periph_sys_core", "sys_internal_div",
	     0x104, 18),
...
static struct pistachio_div pistachio_divs[] __initdata = {
	...
	DIV(CLK_UART0_INTERNAL_DIV, "uart0_internal_div", "sys_pll_mux",
	    0x234, 3),
	DIV(CLK_UART0_DIV, "uart0_div", "uart0_internal_div", 0x238, 10),
	DIV(CLK_UART1_INTERNAL_DIV, "uart1_internal_div", "sys_pll_mux",
	    0x23c, 3),
	DIV(CLK_UART1_DIV, "uart1_div", "uart1_internal_div", 0x240, 10),
...
static struct pistachio_div pistachio_periph_divs[] __initdata = {
	DIV(PERIPH_CLK_ROM_DIV, "rom_div", "periph_sys_core", 0x10c, 7),
	DIV(PERIPH_CLK_COUNTER_FAST_DIV, "counter_fast_div", "periph_sys_core",
	    0x110, 7),
	DIV(PERIPH_CLK_COUNTER_SLOW_PRE_DIV, "counter_slow_pre_div",
	    "periph_sys_core", 0x114, 7),
	DIV(PERIPH_CLK_COUNTER_SLOW_DIV, "counter_slow_div",
	    "counter_slow_pre_div", 0x118, 7),
	DIV(PERIPH_CLK_IR_PRE_DIV, "ir_pre_div", "periph_sys_core", 0x11c, 7),
	DIV(PERIPH_CLK_IR_DIV, "ir_div", "ir_pre_div", 0x120, 7),
	DIV(PERIPH_CLK_WD_PRE_DIV, "wd_pre_div", "periph_sys_core", 0x124, 7),
	DIV(PERIPH_CLK_WD_DIV, "wd_div", "wd_pre_div", 0x128, 7),
	DIV(PERIPH_CLK_PDM_PRE_DIV, "pdm_pre_div", "periph_sys_core", 0x12c, 7),
	DIV(PERIPH_CLK_PDM_DIV, "pdm_div", "pdm_pre_div", 0x130, 7),
	DIV(PERIPH_CLK_PWM_PRE_DIV, "pwm_pre_div", "periph_sys_core", 0x134, 7),
	DIV(PERIPH_CLK_PWM_DIV, "pwm_div", "pwm_pre_div", 0x138, 7),
	DIV(PERIPH_CLK_I2C0_PRE_DIV, "i2c0_pre_div", "periph_sys_core",
	    0x13c, 7),
	DIV(PERIPH_CLK_I2C0_DIV, "i2c0_div", "i2c0_pre_div", 0x140, 7),
	DIV(PERIPH_CLK_I2C1_PRE_DIV, "i2c1_pre_div", "periph_sys_core",
	    0x144, 7),
	DIV(PERIPH_CLK_I2C1_DIV, "i2c1_div", "i2c1_pre_div", 0x148, 7),
	DIV(PERIPH_CLK_I2C2_PRE_DIV, "i2c2_pre_div", "periph_sys_core",
	    0x14c, 7),
	DIV(PERIPH_CLK_I2C2_DIV, "i2c2_div", "i2c2_pre_div", 0x150, 7),
	DIV(PERIPH_CLK_I2C3_PRE_DIV, "i2c3_pre_div", "periph_sys_core",
	    0x154, 7),
