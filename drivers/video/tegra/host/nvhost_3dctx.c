...
static unsigned int context_restore_size;
...
static struct nvmap_handle *context_save_buf;
static u32 context_save_phys;
static u32 *context_save_ptr;
static unsigned int context_save_size;
