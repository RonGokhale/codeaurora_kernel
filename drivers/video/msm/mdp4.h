...
#define FRC_CADENCE_23223_RATIO	24000
#define FRC_CADENCE_122_RATIO	16667
#define FRC_CADENCE_2x11_3_RATIO	20833
...
#define FRC_FRAMERATE_DETECT_SIZE	6
...
int mdp4_overlay_lcdc_unset(struct msm_fb_data_type *mfd,
                                                         struct mdp4_overlay_pipe *pipe);
...
int mdp4_qseed0_access_cfg(struct msm_fb_data_type *mfd, struct mdp_qseed_cfg *cfg, uint32_t base);
