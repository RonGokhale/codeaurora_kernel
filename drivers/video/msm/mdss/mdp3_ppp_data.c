...
const uint32_t pack_patt_lut[MDP_IMGTYPE_LIMIT] = {
	[MDP_RGB_565] = MDP_GET_PACK_PATTERN(0, CLR_R, CLR_G, CLR_B, 8),
	[MDP_BGR_565] = MDP_GET_PACK_PATTERN(0, CLR_B, CLR_G, CLR_R, 8),
	[MDP_RGB_888] = MDP_GET_PACK_PATTERN(0, CLR_R, CLR_G, CLR_B, 8),
	[MDP_BGR_888] = MDP_GET_PACK_PATTERN(0, CLR_B, CLR_G, CLR_R, 8),
	[MDP_BGRA_8888] = MDP_GET_PACK_PATTERN(CLR_ALPHA, CLR_R,
		CLR_G, CLR_B, 8),
	[MDP_RGBA_8888] = MDP_GET_PACK_PATTERN(CLR_ALPHA, CLR_B,
		CLR_G, CLR_R, 8),
	[MDP_ARGB_8888] = MDP_GET_PACK_PATTERN(CLR_ALPHA, CLR_R,
		CLR_G, CLR_B, 8),
	[MDP_XRGB_8888] = MDP_GET_PACK_PATTERN(CLR_ALPHA, CLR_R,
		CLR_G, CLR_B, 8),
	[MDP_RGBX_8888] = MDP_GET_PACK_PATTERN(CLR_ALPHA, CLR_R,
		CLR_G, CLR_B, 8),
	[MDP_Y_CRCB_H2V2] = MDP_GET_PACK_PATTERN(0, 0, CLR_CR, CLR_CB, 8),
	[MDP_Y_CBCR_H2V2] = MDP_GET_PACK_PATTERN(0, 0, CLR_CB, CLR_CR, 8),
	[MDP_Y_CBCR_H2V2_ADRENO] = MDP_GET_PACK_PATTERN(0, 0, CLR_CB,
		CLR_CR, 8),
	[MDP_YCRYCB_H2V1] = MDP_GET_PACK_PATTERN(CLR_Y,
		CLR_CR, CLR_Y, CLR_CB, 8),
	[MDP_Y_CBCR_H2V1] = MDP_GET_PACK_PATTERN(0, 0, CLR_CB, CLR_CR, 8),
	[MDP_Y_CRCB_H2V1] = MDP_GET_PACK_PATTERN(0, 0, CLR_CR, CLR_CB, 8),
};
...
const uint32_t bpp[MDP_IMGTYPE_LIMIT] = {
	[MDP_RGB_565] = 2,
	[MDP_BGR_565] = 2,
	[MDP_RGB_888] = 3,
	[MDP_BGR_888] = 3,
...
uint32_t src_config_lut(uint32_t type)
{
	if (type > MDP_IMGTYPE_LIMIT)
		return 0;
...
uint32_t out_config_lut(uint32_t type)
{
	if (type > MDP_IMGTYPE_LIMIT)
		return 0;
...
uint32_t pack_pattern_lut(uint32_t type)
{
	if (type > MDP_IMGTYPE_LIMIT)
		return 0;
...
bool per_pix_alpha(uint32_t type)
{
	if (type > MDP_IMGTYPE_LIMIT)
		return 0;
...
uint32_t *default_pre_lut(void)
{
	return default_pre_lut_val;
}

uint32_t *default_post_lut(void)
{
	return default_post_lut_val;
}

struct ppp_csc_table *csc_rgb2yuv(void)
{
	return &rgb2yuv;
}

struct ppp_csc_table *csc_default_table2(void)
{
