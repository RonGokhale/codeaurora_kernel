		      ...
		      struct pm8921 *pmic)
{
	...
	if (pdata->bms_pdata) {
		...
		bms_cell.data_size = sizeof(struct pm8921_bms_platform_data);
	...
	if (pdata->leds_pdata) {
		...
		leds_cell.data_size = sizeof(struct pm8xxx_led_platform_data);
