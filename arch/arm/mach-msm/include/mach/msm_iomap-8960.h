...
#define MSM_ACC0_BASE		IOMEM(0xF0003000)
#define MSM_ACC0_PHYS		0x02041000
#define MSM_ACC0_SIZE		SZ_4K

#define MSM_ACC1_BASE		IOMEM(0xF0004000)
...
#define MSM_RPM_MPM_BASE        IOMEM(0xF0103000)
#define MSM_RPM_MPM_PHYS        0x00200000
#define MSM_RPM_MPM_SIZE        SZ_4K

#define MSM_TCSR_BASE		IOMEM(0xF0104000)
#define MSM_TCSR_PHYS		0x1A400000
#define MSM_TCSR_SIZE		SZ_4K

#define MSM_SHARED_RAM_BASE	IOMEM(0xF0200000)
#define MSM_SHARED_RAM_SIZE	(2*SZ_1M)

#define MSM_DMOV_BASE		IOMEM(0xF0400000)
...
#define MSM_TLMM_BASE		IOMEM(0xF0500000)
