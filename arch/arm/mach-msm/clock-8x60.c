...
struct clk_local soc_clk_local_tbl[] = {
	...
	CLK_NORATE(EBI2_2X, EBI2_2X_CLK_CTL_REG, BIT(4), NULL, 0,
		CLK_HALT_CFPB_STATEA_REG, HALT, 18, TEST_PER_LS(0x1D)),
	CLK_SLAVE(EBI2, EBI2_CLK_CTL_REG, BIT(4), NULL, 0,
		CLK_HALT_CFPB_STATEA_REG, HALT, 19, EBI2_2X, TEST_PER_LS(0x1E)),
