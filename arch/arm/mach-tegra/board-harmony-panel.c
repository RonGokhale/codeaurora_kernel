...
static int __init harmony_panel_init(void)
{
	int err;
...
device_initcall(harmony_panel_init);

int __init harmony_fb_init(void)
{
	...
	if (!of_machine_is_compatible("nvidia,harmony") &&
        ...
        /*
	 * reserve 256MB for carveout, 1024*768*4*2 for fb_size,
	 * and 0 for fb2_size.
	 */
