...
static const struct snd_soc_dapm_route adau1781_dapm_routes[] = {
	...
	{ "Playbacl", NULL, "Clock Domain Transfer" },
...
DECLARE_ADAU17X1_capture_mux(adc, "ADC");
...
static const struct snd_soc_dapm_route adau1781_adc_dapm_routes[] = {
	...
	{ "Capture Mux", "ADC", "Left ADC" },
	{ "Capture Mux", "ADC", "Right ADC" },
...
static const char * const adau1781_dmic_capture_mux_text[] = {
	"DMIC",
	"DSP",
};

static const SOC_ENUM_SINGLE_DECL(adau1781_dmic_capture_mux_enum,
	ADAU17X1_SERIAL_OUTPUT_ROUTE, 0, adau1781_dmic_capture_mux_text);

static const struct snd_kcontrol_new adau1781_dmic_capture_mux =
	ADAU17X1_DSP_MUX_ENUM("Capture Mux",
		adau1781_dmic_capture_mux_enum);

static const struct snd_soc_dapm_widget adau1781_dmic_dapm_widgets[] = {
	SND_SOC_DAPM_VIRT_MUX("DMIC Select", SND_SOC_NOPM, 0, 0,
		&adau1781_dmic_mux),

	SND_SOC_DAPM_VIRT_MUX("Capture Mux", SND_SOC_NOPM, 0, 0,
		&adau1781_dmic_capture_mux),
