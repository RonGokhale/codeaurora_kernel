...
static int adau7002_set_dai_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
...
static const struct snd_soc_dai_ops adau7002_dai_ops = {
	.set_fmt = adau7002_set_dai_fmt,
};
