	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		snd_soc_update_bits(codec, MSM8X10_WCD_A_TX_2_EN, 0x80, 0x80);
		break;
	case SND_SOC_DAPM_POST_PMD:
		msm8x10_wcd_codec_enable_adc_block(codec, 0);
		snd_soc_update_bits(codec, MSM8X10_WCD_A_TX_2_EN, 0x80, 0x00);
		break;
	}
	return 0;
}
...
static int msm8x10_wcd_ahb_clk_enable(void)
{
	/* Div-2 */
