...
#define DECLARE_ADAU17X1_CAPTURE_MUX(name, text) \
static const char * const adau17x1_ ## name ## _capture_text[] = { \
	text, \
	"DSP", \
}; \
static const SOC_ENUM_SINGLE_DECL(adau17x1_ ## name ## _capture_mux_enum, \
	ADAU17X1_SERIAL_OUTPUT_ROUTE, 0, adau17x1_ ## name ## _capture_text); \
static const struct snd_kcontrol_new adau17x1_ ## name ## _capture_mux =  \
	ADAU17X1_DSP_MUX_ENUM("Capture Mux", \
	adau17x1_ ## name ## _capture_mux_enum); \
static const struct snd_soc_dapm_widget adau17x1_ ## name ## _dsp_widget = \
	SND_SOC_DAPM_VIRT_MUX("Capture Mux", SND_SOC_NOPM, 0, 0, \
		&adau17x1_ ## name ## _capture_mux) \
