...
static const struct snd_soc_dapm_route adau1761_dapm_routes[] = {
	...
	{ "Playback", NULL, "Decimator Resync Clock" },
	{ "Capture", NULL, "Interpolator Resync Clock" },
	...
	{ "Capture", NULL, "Decimator Resync Clock" },
};
